                ...
                <div class="col-12">
                    <div class="global-slick-init attraction-slider nav-style-one slider-inner-margin" data-appendArrows=".append-attraction" data-infinite="true" data-arrows="true" data-dots="false" data-slidesToShow="4" data-swipeToSlide="true" data-autoplay="true" data-autoplaySpeed="2500"
                        ...
                        <div class="attraction-item">
                            <div class="single-attraction radius-20">
                                <div class="single-attraction-thumb">
                                    <a href="hotel_details.html"> <img src="assets/img/attraction/a1.jpg" alt="img"> </a>
                                </div>
                        ...
                        <div class="attraction-item">
                            <div class="single-attraction radius-20">
                                <div class="single-attraction-thumb">
                                    <a href="hotel_details.html"> <img src="assets/img/attraction/a2.jpg" alt="img"> </a>
                                </div>
                                <div class="single-attraction-contents">
                        ...
                        <div class="attraction-item">
                            <div class="single-attraction radius-20">
                                <div class="single-attraction-thumb">
                                    <a href="hotel_details.html"> <img src="assets/img/attraction/a3.jpg" alt="img"> </a>
                                </div>
                                <div class="single-attraction-contents">
                        ...
                        <div class="attraction-item">
                            <div class="single-attraction radius-20">
                                <div class="single-attraction-thumb">
                                    <a href="hotel_details.html"> <img src="assets/img/attraction/a4.jpg" alt="img"> </a>
                                </div>
                                <div class="single-attraction-contents">
                ...
                <div class="custom-tab-menu">
                    <ul class="tab-menu guest-wrapper-images list-style-none">
                        <li class="guest-wrapper-images-single active">
                            <img src="assets/img/guest/guest1.jpg" alt="">
                        </li>
                        <li class="guest-wrapper-images-single">
                            <img src="assets/img/guest/guest2.jpg" alt="">
                        </li>
                        <li class="guest-wrapper-images-single">
                            <img src="assets/img/guest/guest3.jpg" alt="">
                        </li>
                        <li class="guest-wrapper-images-single">
                            <img src="assets/img/guest/guest4.jpg" alt="">
                        </li>
                        <li class="guest-wrapper-images-single">
                            <img src="assets/img/guest/guest5.jpg" alt="">
                        </li>
                        <li class="guest-wrapper-images-single">
                            <img src="assets/img/guest/guest6.jpg" alt="">
                        </li>
                    </ul>
                </div>
                ...
                <div class="row g-4 masonry-grid">
                    <div class="col-lg-2 col-md-4 col-sm-6 grid-item">
                        <div class="single-shots bg-image" style="background-image: url(assets/img/shots/shot1.jpg);">
                            ...
                            <div class="single-shots-contents">
                                <h4 class="single-shots-contents-title"> <a href="hotel_details.html"> Disneyland </a> </h4>
                                <p class="single-shots-contents-para"> We have over 28K reviews to assure you top notch service. We have over 28K reviews to assure you top notch service.We have over 28K reviews to assure you top notch service. We have over 28K reviews to assure you top notch
                                    service. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 grid-item">
                        <div class="single-shots bg-image" style="background-image: url(assets/img/shots/shot2.jpg);">
                            ...
                            <div class="single-shots-contents">
                                <h4 class="single-shots-contents-title"> <a href="hotel_details.html"> Disneyland </a> </h4>
                                <p class="single-shots-contents-para"> We have over 28K reviews to assure you top notch service. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 grid-item">
                ...
                <div class="col-xxl-4 col-lg-4 col-md-6">
                    <div class="single-blog">
                        <div class="single-blog-thumbs">
                            <a href="blog_details.html"> <img class="lazyloads" src="assets/img/blog/blog1.jpg" alt=""> </a>
                        ...
                        <div class="single-blog-contents mt-3">
                            ...
                            <h4 class="single-blog-contents-title mt-3"> <a href="blog_details.html"> Great Deals to Send Your Loved Ones Somewhere Nice </a> </h4>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-lg-4 col-md-6">
                    <div class="single-blog">
                        ...
                        <div class="single-blog-contents mt-3">
                            ...
                            <h4 class="single-blog-contents-title mt-3"> <a href="blog_details.html"> Read Real Guest Reviews. 24/7 Customer Service and others. </a> </h4>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-lg-4 col-md-6">
                    <div class="single-blog">
                        ...
                        <div class="single-blog-contents mt-3">
                            ...
                            <h4 class="single-blog-contents-title mt-3"> <a href="blog_details.html"> Compare hotel prices and find an amazing price for the Resort </a> </h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="newsletter-wrapper newsletter-bg radius-20 newsletter-wrapper-padding wow zoomIn" data-wow-delay=".3s">
                        ...
                        <div class="newsletter-contents center-text">
                            ...
                            <p class="newsletter-contents-para mt-3"> Get discounts and newsletters on our hotels in your email. We promise to not spam. Unsubscribe anytime </p>
